...
module.exports = (req, res, next) => {
  ...
  if (authHeader) {
    ...
    // IMPORTANT: Do NOT fall through to session check when auth header was provided.
    // The DB query callback above will call next() or send a response asynchronously.
    return;
  }
