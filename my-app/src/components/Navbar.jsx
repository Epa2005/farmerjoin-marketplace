                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute right-0 mt-2 w-40 bg-white rounded-lg shadow-xl border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                                <button
                                    onClick={() => changeLanguage('en')}
                                    className={`w-full text-left px-4 py-2 text-sm ${language === 'en' ? 'bg-emerald-50 text-emerald-600' : 'text-gray-700 hover:bg-gray-50'} rounded-t-lg`}
                                >
                                    🇬🇧 English
                                </button>
                                <button
                                    onClick={() => changeLanguage('fr')}
                                    className={`w-full text-left px-4 py-2 text-sm ${language === 'fr' ? 'bg-emerald-50 text-emerald-600' : 'text-gray-700 hover:bg-gray-50'}`}
                                >
                                    🇫🇷 Français
                                </button>
                                <button
                                    onClick={() => changeLanguage('rw')}
                                    className={`w-full text-left px-4 py-2 text-sm ${language === 'rw' ? 'bg-emerald-50 text-emerald-600' : 'text-gray-700 hover:bg-gray-50'} rounded-b-lg`}
                                >
                                    🇷🇼 Kinyarwanda
                                </button>
                            </div>
