            ...
            <div className="flex items-center space-x-4">
              <div className="flex-1">
                <div className="relative">
                  <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">FRW</span>
                  <input
                    type="number"
                    min="0"
                    max={priceRange.max}
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {priceRange.min > 0 && (
              <div className="badge badge-warning flex items-center space-x-1">
                <span>Min: FRW {priceRange.min}</span>
                <button
            ...
            {priceRange.max < 100 && (
              <div className="badge badge-warning flex items-center space-x-1">
                <span>Max: FRW {priceRange.max}</span>
                <button
