        ...
        <div className="mb-4 flex flex-wrap gap-2">
          ...
          {(priceRange.min > 0 || priceRange.max < 1000) && (
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-green-100 text-green-800">
              RWF {priceRange.min} - RWF {priceRange.max}
              <button
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-4">
                <input
                  ...
                  className="flex-1"
                />
                <span className="text-sm font-medium text-gray-600 w-20">RWF {priceRange.min}</span>
              </div>
              <div className="flex items-center space-x-4">
                <input
                  type="range"
                  ...
                  className="flex-1"
                />
                <span className="text-sm font-medium text-gray-600 w-20">RWF {priceRange.max}</span>
              </div>
            </div>
          </div>
