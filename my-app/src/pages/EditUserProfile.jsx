...
function EditUserProfile() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Dispatch events to notify other components (like Navbar) of profile update
            // 'storage' is fired in other tabs, but not the current window — so also dispatch a custom event
            try {
