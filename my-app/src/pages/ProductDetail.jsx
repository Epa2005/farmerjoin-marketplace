...
function ProductDetail() {
    ...
    const getImageCandidates = (imageValue) => {
        ...
        const candidates = [
            buildImageUrl(raw),
            buildImageUrl(`uploads/products/${filename}`),
            buildImageUrl(`uploads/${filename}`),
    ...
    const handleImageError = (e, imageValue, fallbackHtml) => {
        const img = e.currentTarget;
        const candidates = getImageCandidates(imageValue);
        ...
        if (img.parentElement && fallbackHtml) {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                        ...
                                        <img
                                            ...
                                            onError={(e) => {
                                                ...
                                                handleImageError(
                                                    e,
                                                    selectedImage,
                                                    '<div class="w-full h-full bg-gradient-to-br from-emerald-100 to-cyan-100 dark:from-emerald-900/20 dark:to-cyan-900/20 flex items-center justify-center"><span class="text-6xl">🌾</span></div>'
                                                );
                                            }}
                                        />
                                    ) : (
                                            ...
                                            <img
                                                ...
                                                onError={(e) => {
                                                    handleImageError(
                                                        e,
                                                        product.image,
                                                        '<div class="w-full h-full flex items-center justify-center"><span class="text-xl">🌾</span></div>'
                                                    );
                                                }}
                                            />
                                        </div>
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <span className="text-sm text-gray-500 dark:text-gray-400">
                                    {t('available', 'Available')}: {product.quantity}
                                </span>
                            </div>
                        ...
                        {/* {t('relatedProducts', 'Related Products')} from Same Farmer */}
                        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
